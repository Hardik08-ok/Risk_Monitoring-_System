...
export default function AnalyticsPage({ liveData }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      {/* Row 1: score distribution + regional comparison */}
      <div className="tg-analytics-row">
        ...
        <ChartCard title="Regional Risk Comparison">
          <ResponsiveContainer width="100%" height={180}>
            <BarChart
              data={riskData.slice(0, 8).map(r => ({ name: r.region.split(',')[0], score: r.score, color: r.color }))}
              layout="vertical"
      ...
      <ChartCard title={
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <select value={selectedId} onChange={e => setSelectedId(e.target.value)} style={{
            ...
            padding: '2px 6px', color: '#94a3b8', fontSize: 11,
          }}>
      ...
      <div className="tg-analytics-row">
        ...
        <ChartCard title="🧮 AI Risk Calculator (Predictive Engine v2.0)">
          {/* tg-calc-inner: row on desktop, column on mobile */}
          <div className="tg-calc-inner">
            <div style={{ flex: 1 }}>
        ...
        {/* Comparison Matrix — horizontal scroll on very narrow screens */}
        <ChartCard title="📋 Paradigm Comparison Matrix">
          <div className="tg-comparison-table">
      ...
      <div style={{ background: '#0f172a', border: '1px solid #1e293b', borderRadius: 8, padding: '10px 16px' }}>
        <div style={{ fontSize: 10, color: '#3b82f6', fontFamily: 'monospace', wordBreak: 'break-word' }}>
